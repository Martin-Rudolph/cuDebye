...
void splitCalcDist(int BlockDimXY, int GridDimXY, int *start_group, int *end_group, float *dev_rp_rstep, float *dev_x, float *dev_y, float *dev_z, unsigned int *dev_nr) {
	...
	cout << "\nNumber of Rowwise Loops: " << LoopDimY << ", Y-Grid-Dimension for the Last Loop: " << LastLoopGridDimY << endl;
	cout << "Number of Columnwise Loops: " << LoopDimX << ", X-Grid-Dimension for the Last Loop: " << LastLoopGridDimX << endl;
	cout << endl;
...
//void main()
{
	...
	cout << " - Calculation of distances with square root in the kernel fucntion" << endl;
	...
	// Display the importent device properties
	...
	cout << "\nNote: in Cuda the X-Dimension describes the Column and the Y-Dimension the Rows.";
	...
	cout << "2ThetaMin: " << TwoThetaMin << "\t2ThetaMax: " << TwoThetaMax << "\t2ThetaStep: " << TwoThetaStep << endl;
	cout << "Number of 2Theta values: " << nTT << "\tStart: 0 = " << TwoTheta[0] << "\tEnd: " << nTT - 1 << " = " << TwoTheta[nTT - 1] << endl;
